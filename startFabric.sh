...
echo "SRC_PATH = $CC_SRC_PATH" | tr [:upper:] [:lower:]
./network.sh deployCC -ccn DocProject -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
popd
